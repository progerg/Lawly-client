...
const Color milkyWhite = _milkyWhite;
const Color lightGray = _lightGray;
const Color lightBlue = _lightBlue;
...
const Color darkWhite = _darkWhite;
const Color darkGray = _darkGray;

const Color _white = Colors.white;
const Color _black = Colors.black;
const Color _milkyWhite = Color(0xFFF2EDE7);
const Color _darkWhite = Color.fromARGB(255, 231, 224, 215);
const Color _lightGray = Color(0xFFE4E4E4);
