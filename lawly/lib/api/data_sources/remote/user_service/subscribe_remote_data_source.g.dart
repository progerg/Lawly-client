...
class _SubscribeRemoteDataSource implements SubscribeRemoteDataSource {
  ...
  Future<void> setSubscribe({required int tariffId}) async {
    ...
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'tariff_id': tariffId};
  ...
  @override
  Future<SubscribeModel> getSubscribe() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SubscribeModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/subscribe',
    ...
    late SubscribeModel _value;
    try {
      _value = SubscribeModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
