...
class _TemplatesRemoteDataSource implements TemplatesRemoteDataSource {
  ...
  Future<List<int>> downloadEmptyTemplate({
    ...
    final _data = {'template_id': templateId};
    final _options = _setStreamType<List<int>>(
      Options(
        ...
        responseType: ResponseType.bytes,
          ...
          .compose(
            _dio.options,
            '/api/v1/templates/download-empty-template',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<ImproveTextModel> improveText({required String text}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'text': text};
    final _options = _setStreamType<ImproveTextModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ImproveTextModel _value;
    try {
      _value = ImproveTextModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
